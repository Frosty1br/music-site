...
function setVolume(){
  song[index_no].volume = volumeslider.value / 100;
}
...
function play_song(){
  ...
  song_img.innerHTML = `<img src="images/${All_song[index_no].src}.jpg" />`; //img
  playing_img.innerHTML = `<img src="images/${All_song[index_no].src}.jpg" />`; //img
  ...
  current_singer_name.innerHTML = All_song[index_no].artist;
